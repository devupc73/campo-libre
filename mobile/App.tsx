...
export default function App() {
  ...
  async function checkBackend() {
    ...
    try {
      ...
      setMessage('No se pudo conectar con el backend. Revisa la URL del API o CORS.');
    }
  }
    ...
    return (
      <View style={styles.card}>
        ...
        <Text style={styles.subtitle}>
          Reserva campos deportivos, convoca jugadores, registra pagos y arma equipos.
        </Text>
        ...
        <TouchableOpacity style={styles.secondaryButton} onPress={checkBackend}>
